#!/usr/bin/env bash
#
# Build & run the multi-account test instance of DBX on port 4230.
# Data is stored in a separate Docker volume (dbx-multi-account-data)
# so it never touches your production instance on port 4224.
#
set -euo pipefail
