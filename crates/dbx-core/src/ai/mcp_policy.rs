...
use crate::storage::McpUserPolicy;
...
pub fn policy_uses_connection_groups(policy: &McpUserPolicy) -> bool {
...
mod tests {
    ...
    use crate::storage::{McpConnectionPolicy, McpDatabasePolicy, McpUserPolicy};

    fn policy(version: Option<u8>) -> McpUserPolicy {
        McpUserPolicy {
            read_only: true,
