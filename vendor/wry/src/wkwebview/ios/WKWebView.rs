...
impl WKWebView {
    extern_methods!(
        ...
        pub unsafe fn pauseAllMediaPlayback(&self, completion_handler: Option<&block2::Block<dyn Fn()>>);
        ...
        pub unsafe fn resumeAllMediaPlayback(&self, completion_handler: Option<&block2::Block<dyn Fn()>>);

        // #[cfg(feature = "block2")]
        #[deprecated]
        #[unsafe(method(suspendAllMediaPlayback:))]
        pub unsafe fn suspendAllMediaPlayback(&self, completion_handler: Option<&block2::Block<dyn Fn()>>);
