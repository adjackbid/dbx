...
use objc2_web_kit::{
    WKDownload, WKNavigation, WKNavigationAction, WKNavigationActionPolicy, WKNavigationDelegate, WKNavigationResponse,
...
define_class!(
    ...
    unsafe impl WKNavigationDelegate for WryNavigationDelegate {
        ...
        fn navigation_download_action(&self, webview: &WKWebView, action: &WKNavigationAction, download: &WKDownload) {
...
impl WryNavigationDelegate {
    ...
    pub fn new(
        ...
        let delegate = mtm.alloc::<WryNavigationDelegate>().set_ivars(WryNavigationDelegateIvars {
            pending_scripts,
