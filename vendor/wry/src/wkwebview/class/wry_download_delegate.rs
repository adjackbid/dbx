...
use objc2_foundation::{MainThreadMarker, NSData, NSError, NSObjectProtocol, NSString, NSURLResponse, NSURL};
...
impl WryDownloadDelegate {
    pub fn new(
        ...
        let delegate = mtm.alloc::<WryDownloadDelegate>().set_ivars(WryDownloadDelegateIvars {
