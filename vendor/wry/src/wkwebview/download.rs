...
use super::class::{wry_download_delegate::WryDownloadDelegate, wry_navigation_delegate::WryNavigationDelegate};
...
pub(crate) fn download_policy(
    ...
    unsafe {
        ...
        let mut download_destination = dirs::download_dir().unwrap_or_else(|| current_dir().unwrap_or_default());
