...
export default withEnglishFallback({
  ...
  settings: {
    ...
    adminOnlySetting: "Apenas um administrador pode alterar esta configuração.",
    aboutTab: "Sobre",
    ...
    mcpConfigOptionsHint:
      "O DBX limita o acesso às conexões e as permissões de execução à conta conectada, e elas se aplicam a todos os clientes MCP que se conectam com essa conta. A configuração gerada contém apenas os parâmetros de execução necessários para iniciar o servidor MCP e conectá-lo a esta instância do DBX, sem variáveis de permissão ou escopo de conexão.",
    mcpScopeConnection: "Conexões permitidas para MCP",
    mcpScopeConnectionDescription: "O DBX expõe ao MCP apenas as conexões selecionadas para esta conta. As alterações se aplicam aos clientes MCP que se conectam com esta conta.",
    ...
    mcpExecutionModeDescription: "Escolha o nível de permissão que o DBX aplica aos clientes MCP desta conta. As configurações de leitura e gravação do cliente não podem alterar este nível.",
