...
export default withEnglishFallback({
  ...
  settings: {
    ...
    adminOnlySetting: "Solo un amministratore può modificare questa impostazione.",
    ...
    mcpConfigOptionsHint:
      "DBX limita l'accesso alle connessioni e i permessi di esecuzione all'account con cui si è effettuato l'accesso, e si applicano a tutti i client MCP che si connettono con questo account. La configurazione generata contiene solo i parametri di runtime necessari per avviare il server MCP e collegarlo a questa istanza DBX, senza variabili di autorizzazione o ambito connessione.",
    mcpScopeConnection: "Connessioni consentite per MCP",
    mcpScopeConnectionDescription: "DBX espone a MCP solo le connessioni selezionate per questo account. Le modifiche si applicano ai client MCP che si connettono con questo account.",
    ...
    mcpExecutionModeDescription: "Scegli il livello di autorizzazione applicato da DBX ai client MCP di questo account. Le impostazioni di lettura e scrittura del client non possono modificare questo livello.",
