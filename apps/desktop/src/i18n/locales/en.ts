...
export default {
  ...
  settings: {
    ...
    mcpExecutionModeDescription: "Choose the permission level DBX enforces for this account's MCP clients. Client-side read/write settings cannot change this level.",
