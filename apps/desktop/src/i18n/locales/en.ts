...
export default {
  ...
  settings: {
    ...
    adminOnlySetting: "Only an administrator can change this setting.",
    aboutTab: "About",
    ...
    mcpConfigOptionsHint:
      "DBX scopes connection access and execution permissions to the signed-in account, and they apply to every MCP client that connects as this account. Generated configs contain only the runtime settings needed to start the MCP server and connect to this DBX instance, with no permission or connection-scope variables.",
    mcpScopeConnection: "Connections allowed for MCP",
    mcpScopeConnectionDescription: "DBX exposes only the connections selected for this account to MCP. Changes apply to the MCP clients connecting as this account.",
    ...
    mcpExecutionMode: "MCP execution permission default",
    mcpExecutionModeDescription: "Default level DBX enforces for this account's MCP clients. Connection and database settings can override it by scope.",
