...
export default withEnglishFallback({
  ...
  settings: {
    ...
    adminOnlySetting: "Solo un administrador puede cambiar esta configuración.",
    aboutTab: "Acerca de",
    ...
    mcpConfigOptionsHint:
      "DBX limita el acceso a las conexiones y los permisos de ejecución a la cuenta con la que se ha iniciado sesión, y se aplican a todos los clientes MCP que se conectan con esa cuenta. La configuración generada solo contiene los parámetros de ejecución necesarios para iniciar el servidor MCP y conectarlo a esta instancia de DBX, sin variables de permisos ni de ámbito de conexión.",
    mcpScopeConnection: "Conexiones permitidas para MCP",
    mcpScopeConnectionDescription: "DBX solo expone a MCP las conexiones seleccionadas para esta cuenta. Los cambios se aplican a los clientes MCP que se conectan con esta cuenta.",
    ...
    mcpExecutionModeDescription: "Elige el nivel de permiso que DBX aplica a los clientes MCP de esta cuenta. La configuración de lectura y escritura del cliente no puede cambiar este nivel.",
